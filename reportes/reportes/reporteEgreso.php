...
session_start();
    ...
    conectarse();    
    $sql=pg_query("select * from egresos,usuario,empresa where egresos.id_usuario=usuario.id_usuario and egresos.id_empresa=empresa.id_empresa and comprobante='$_GET[comprobante]' and usuario.id_usuario='$_SESSION[id]'");        
